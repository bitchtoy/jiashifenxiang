...
public class InvestmentOrderAdapter extends BaseQuickAdapter<Integer, RecyclerViewHolder> {

    private int tag = 0;
    public InvestmentOrderAdapter(@LayoutRes int layoutResId, @Nullable List<Integer> data,int tag) {

...
public class RentOrderAdapter extends BaseQuickAdapter<Integer, RecyclerViewHolder> {
    private int tag;
    public RentOrderAdapter(@LayoutRes int layoutResId, @Nullable List<Integer> data ,int tag) {
        super(R.layout.adapter_order_rent_item, data);
        this.tag = tag;
    }

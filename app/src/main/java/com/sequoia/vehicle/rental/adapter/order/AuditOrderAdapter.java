...
public class AuditOrderAdapter extends BaseQuickAdapter<Integer, RecyclerViewHolder> {
    private int tag = 0;

    public AuditOrderAdapter(@LayoutRes int layoutResId, @Nullable List<Integer> data, int tag) {
    ...
    protected void convert(RecyclerViewHolder helper, Integer item) {
        ...
        helper.addOnClickListener(R.id.tv_audit_completed);
        ...
        switch (tag) {
            case 0:
                ...
                helper.setVisible(R.id.tv_audit_completed, true);
                break;
            case 1:
                helper.setVisible(R.id.tv_cancel, true);
            ...
            case 2:
                ...
                helper.setVisible(R.id.tv_see_details, true);
                break;
            default:
                break;
        }

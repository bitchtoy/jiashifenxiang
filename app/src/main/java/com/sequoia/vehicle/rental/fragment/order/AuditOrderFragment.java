...
public class AuditOrderFragment extends LazyFragment implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    public static AuditOrderFragment getInstance(int tag) {
        Bundle bundle = new Bundle();
        bundle.putInt(TAG, tag);
        AuditOrderFragment fragment = new AuditOrderFragment();
    ...
    public void initData() {
        ...
        AuditOrderAdapter adapter = new AuditOrderAdapter(R.layout.adapter_order_audit_item, list, mTag);
